...
store.dispatch({ type: _constants.ACTIONS.ADD_TODO, id: 1, text: 'MY TODO 1' });
store.dispatch({ type: _constants.ACTIONS.ADD_TODO, id: 2, text: 'MY TODO 2' });
...
var todoReducer = function todoReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
    todos: [],
    filter: _constants.FILTERS.ALL
  };
  var action = arguments[1];

  switch (action.type) {
    case _constants.ACTIONS.ADD_TODO:
    ...
    case _constants.ACTIONS.REMOVE_TODO:
      return Object.assign({}, state, {
        todos: state.todos.filter(function (todo) {
          return todo.id !== action.id ? true : false;
        })
      });
    case _constants.ACTIONS.TOGGLE_TODO:
    ...
    case _constants.ACTIONS.CHANGE_FILTER:
